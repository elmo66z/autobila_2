...
import Data_w from './json/wheels.json';
...
const Detalis_wheels = () => {

    const {producttitle} = useParams();
    const thisproduct = Data_w.find(prod => prod.title === producttitle);
    ...
    return (
        <>
            ...
            <div className="div-item">
                <Nav_cat />
                <h1>/ Wheels & Rims / {thisproduct.title}</h1>
                {isLoading ? (
                        <Load />
                    ) : (
                ...
                <div className="random-products-slider">
                    ...
                    <div className="slider-container" onClick={() => {
                        ...
                        {randomProducts.map((product, index) => (
                            <Link to={`/DetailsWheels/${product.title}`} key={index}>
