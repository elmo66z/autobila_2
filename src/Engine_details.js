...
import Data_e from './json/Engine.json';
...
const Detalis_Engine= () => {

    const {producttitle} = useParams();
    const thisproduct = Data_e.find(prod => prod.title === producttitle);
    ...
    return (
        <>
            ...
            <div className="div-item">
                <Nav_cat />
                <h1>/  Engine / {thisproduct.title}</h1>
                {isLoading ? (
                        <Load />
                ) : (
                ...
                <div className="random-products-slider">
                    ...
                    <div className="slider-container" onClick={() => {
                        ...
                        {randomProducts.map((product, index) => (
                            <Link to={`/DetailEngine/${product.title}`} key={index}>
